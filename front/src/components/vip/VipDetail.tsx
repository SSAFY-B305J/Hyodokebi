  ...
  return (
    <div className="box-border flex flex-col flex-1 p-3">
      <div className="flex flex-row justify-between my-3">
        <div className="flex text-2xl font-semibold">{VipTestData[vipIndex].name} 님의 정보</div>
        <Link to={`/mypage/${id}`}>
      ...
      <div className="flex flex-col justify-center w-full h-full m-2">
        <div className="flex flex-row justify-around w-2/3 h-1/2 ">
          <img src={VipTestData[vipIndex].imagePath} alt="" className="w-[208px] h-[208px]" />
          <div className="flex flex-col justify-between">
            <p className="font-semibold">닉네임 : {VipTestData[vipIndex].name}</p>
            <p className="font-semibold">나이대 : {VipTestData[vipIndex].ageRange}</p>
