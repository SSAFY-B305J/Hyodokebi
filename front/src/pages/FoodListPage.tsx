      ...
      <div className="flex flex-col ">
        ...
        <div className="flex h-20 p-1 mb-1 ">
          ...
          <div className="flex flex-row p-3 grow">
            <div className="flex w-1/6 mr-3 ">
              <button className="flex items-center justify-center w-full bg-white border drop-shadow-lg border-silver rounded-2xl w-10screen">
                하나
              </button>
            </div>
            <div className="flex w-1/6 mr-3 ">
              <button className="flex items-center justify-center w-full bg-white border drop-shadow-lg border-silver rounded-2xl">
                둘
              </button>
            </div>
        ...
        <div className="flex flex-row justify-end justify-around mt-5 ">
          ...
          <div className="flex w-1/6 pl-3 pr-3">
            <button className="flex items-center justify-center w-full h-full bg-white border drop-shadow-lg text-primary border-primary rounded-3xl">
              저장하기
            </button>
          </div>
        </div>
